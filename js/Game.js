  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //use data form the database to display the bikes in x and y direction
        ...
        if (index === player.index) {
          ...
          this.handlebikeACollisionWithCarB(index); //C41//BP//TA
